...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgIData(oldp+2,(vlSelf->top__DOT__lightSequence__DOT__current_state),32);
        bufp->chgIData(oldp+3,(vlSelf->top__DOT__lightSequence__DOT__next_state),32);
    }
    bufp->chgBit(oldp+4,(vlSelf->clk));
    bufp->chgBit(oldp+5,(vlSelf->rst));
    bufp->chgBit(oldp+6,(vlSelf->en));
    bufp->chgCData(oldp+7,(vlSelf->N),8);
